...
from nanocursor.teams.models import resolve_team_dir
from nanocursor.tools.team_create import TeamCreateTool, TeamCreateParams
from nanocursor.tools.team_delete import TeamDeleteTool, TeamDeleteParams
from nanocursor.tools import ToolRegistry
from nanocursor.tools.base import Tool, ToolResult


@pytest.fixture(autouse=True)
def isolated_team_home(tmp_path):
    """Keep coordinator regression tests out of the user's global config directory."""
    with patch("nanocursor.teams.models.Path.home", return_value=tmp_path):
        yield
