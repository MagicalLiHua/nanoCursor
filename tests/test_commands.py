...
from nanocursor.commands.parser import complete, parse_command
from nanocursor.commands.registry import (
    Command,
    CommandContext,
    CommandRegistry,
    CommandType,
...
class TestHelpHandler:
    ...
    async def test_list_all(self) -> None:
        ...
        from nanocursor.commands.handlers.help import handle_help
...
class TestPlanDoHandlers:
    ...
    async def test_plan_switches_mode(self) -> None:
        from nanocursor.commands.handlers.plan import handle_plan
...
class TestSkillHandler:
    ...
    async def test_skill_list_no_loader(self) -> None:
        from nanocursor.commands.handlers.skill import handle_skill
...
class TestStatusHandler:
    ...
    async def test_status_output(self) -> None:
        ...
        assert "NanoCursor 状态" in ui.messages[0]
...
class TestMemoryHandler:
    ...
    async def test_memory_display(self) -> None:
        from nanocursor.commands.handlers.memory import handle_memory
