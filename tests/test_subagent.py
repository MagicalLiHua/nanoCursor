...
from nanocursor.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from nanocursor.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from nanocursor.agents.trace import TraceManager, TraceNode
from nanocursor.agents.task_manager import BackgroundTask, TaskManager
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".nanocursor" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from nanocursor.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from nanocursor.tools.agent_tool import AgentToolParams
