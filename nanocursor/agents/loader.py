...
PROJECT_AGENTS_DIR = ".nanocursor/agents"
USER_AGENTS_DIR = "~/.nanocursor/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("nanocursor.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from nanocursor.agents.parser import parse_frontmatter, _validate_agent_meta
