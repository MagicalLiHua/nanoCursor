...
def build_teammate_tools(
    ...
    from nanocursor.teams.models import BackendType
    from nanocursor.tools.send_message import SendMessageTool
    from nanocursor.tools.task_create import TaskCreateTool
    from nanocursor.tools.task_get import TaskGetTool
    from nanocursor.tools.task_list import TaskListTool
    from nanocursor.tools.task_update import TaskUpdateTool
