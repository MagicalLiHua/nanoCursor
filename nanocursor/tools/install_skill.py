...
class InstallSkillTool(Tool):
    """从 URL 下载并安装 skill 到用户全局目录 (~/.nanocursor/skills/)。
    ...
    description = (
        ...
        "(~/.nanocursor/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from nanocursor.skills.install import parse_skill_url, install_skill
